...
app.get('/products/ProductProfit',  products.ProfitperProd);
...
//setup the handlers
app.get('/purchases/search/:searchVal',  purchases.search);
...
//setup the handlers
app.get('/suppliers/search/:searchVal',  suppliers.search);
